...
for student in range(len(gradebook)):
    for assigment in range(len(gradebook)):
        
        assignment_sum += gradebook[assigment][student]
    
    assignment_average.append(assignment_sum/len(gradebook))
...
for student in gradebook:
    ...
    student_average.append(sum/len(gradebook))

print("Assignment Averages:")
for item in range(len(assignment_average)):
    print(f"Assignment {item + 1}: {assignment_average[item]}")
print("\nStudent Averages:")
for item in range(len(student_average)):
    print(f"Student {item + 1}: {student_average[item]}")
